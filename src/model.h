...
private:
    ...
    std::vector<std::vector<Vec3i> > faces; //this Vec3i means vertex/uv/normal ids

    std::vector<Vec3f> norms;
    std::vector<Vec2f> texcoords;
public:
    Model(const char *filename, float scale, float delta); //видоизмененная функция парсинга модели
